    ...
    var combo = new Ext.form.ComboBox({
      ...
      listeners: {
        select: function(c, r, i){
          ...
          var rowIndex = 0;
          var gp = pagingToolbar.findParentByType(Ext.grid.GridPanel);
            if(!gp)   gp = pagingToolbar.findParentByType(Ext.ux.grid.SSNJGrid1);
//          var gp = pagingToolbar.findParentByType(Customer.Grid);
